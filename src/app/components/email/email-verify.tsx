...
export default function EmailVerifyBDC({ token }: EmailVerifyBDCProps) {
  return (
    <Html>
      <Head>
        <link
      ...
      <Body style={main}>
        <Preview>Bungah Dental Care Email Verification</Preview>
        <Container style={container}>
          <Section style={coverSection}>
            ...
            <Section style={upperSection}>
              <Heading style={h1}>
                Verifikasi Email Anda Untuk Mengaktifkan Akun Anda
              </Heading>
              <Text style={mainText}>
                Terimakasih telah mendaftar pada bungah dental care! untuk
                menyelesaikan proses registrasi dan mulai membuat janji temu
                dengan dokter jikalau memiliki keluhan pada gigi, tolong
                verifikasi email anda dengan memasukan kode OTP berikut:
              </Text>
              <Hr style={divider} />
            ...
            <Section style={lowerSection}>
              ...
              <Text style={cautionText}>
                Jika anda tidak mendaftar untuk akun Bungah Dental Care, tolong
                abaikan email ini. Bungah Dental Care tidak akan menanyakan
                untuk membagikan password anda, kartu kredit, atau detail bank
                melalui email.
              </Text>
            </Section>
          </Section>
